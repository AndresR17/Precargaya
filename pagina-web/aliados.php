...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="container">
            <a href="index.php"><img  src="./img/logo-antes.jpg" class="menu-icono" alt="logo de empresa"></a>


            <a href="index.php" class="navbar-brand"><span>RecargaYa!</span></a>
            ...
            <div class="collapse navbar-collapse " id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="index.php" id="#servicios" class="nav-link">Servicios</a>
                    </li>

                    <li class="nav-item">
                        <a href="#aliados" class="nav-link" >Contacto</a>
                    </li>
