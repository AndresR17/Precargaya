        ...
        <div class="px-10 pt-10">
            ...
            <form autocomplete="off" method="POST" id="formRecuperarPassword">
                    ...
                    <div id="resEmailRecuperar" class="mb-6">
                        ...
                        <input type="email" id="email-Recuperar" class="border text-base text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"  />
                    </div>
