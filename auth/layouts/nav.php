...
<aside id="logo-sidebar" class="bg-gray-800 fixed top-0 left-0 z-40 w-72 h-screen pt-28 transition-transform -translate-x-full border-r border-gray-600 sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-6 pb-4 overflow-y-auto bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="dashboard.php" class="<?= ($current_page == "dashboard.php") ? 'bg-blue-600' : 'hover:bg-gray-700'; ?> flex items-center py-2 px-4 rounded-lg group hover:text-white text-gray-200 text-base">
            ...
            <li>
                <a href="aliados.php" class="<?= ($current_page == "aliados.php") ? 'bg-blue-600' : 'hover:bg-gray-700'; ?> flex items-center py-2 px-4 rounded-lg group hover:text-white text-gray-200 text-base">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <li>
                <a href="../index.php" target="_blank" class="flex items-center py-2 px-4 rounded-lg group hover:text-white text-gray-200 hover:bg-gray-700 text-base">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
