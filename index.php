...
<!-- <section data-aos="zoom-out-left" class="mt-24 gap-6">
    <div class="bg-gray-800 py-10 px-6 space-y-2">
        ...
        <p class="text-gray-300 text-justify md:text-center text-center">
            Agradecemos tu colaboración al compartir tus comentarios. Juntos, trabajaremos para
...
<!-- <section data-aos="zoom-out-up" class="flex justify-center items-center mx-auto md:mx-[2rem] xl:mx-[10rem] mt-24 gap-6 px-10 ">
    ...
    <form class="w-[35rem]" id="formClientes" method="POST">
        <div class="mb-6" id="resDoc">
            <label for="documento" class="block mb-2 text-sm font-medium text-gray-900 text-white">No Documento:</label>
        ...
        <div class="mb-6" id="resPhone">
            <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 text-white">Telefono:</label>
        ...
        <div class="mb-6">
            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 text-white">Mensaje:</label>
